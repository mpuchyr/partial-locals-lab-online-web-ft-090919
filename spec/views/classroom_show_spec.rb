...
RSpec.describe 'classroom_show_view' do
  ...
  let(:student) { Student.create(name: 'Bobby', hometown: Faker::Address.city, birthday: Faker::Date.between(from: 18.years.ago, to: 25.years.ago)) }
  ...
  #   student = Student.create(name: 'Bobby', hometown: Faker::Address.city, birthday: Faker::Date.between(from: 18.years.ago, to: 25.years.ago))
